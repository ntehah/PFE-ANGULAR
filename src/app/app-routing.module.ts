...
const routes: Routes = [
  {path: 'editNiveou/:id', component: EditNiveouComponent},
  {
    path: "EditFillier/:id", component: EditFillierComponent
  },
  {
    path: "EditGroup/:id", component: EditGroupComponent
  },
  {
    path: "EditDepartement/:id", component: EditDepartementComponent
  },
  {
    path: "EditEtudiant/:id", component: EditEtudiantComponent
  },
  {
    path: "EditEnsegniant/:id", component: EditEnsegniantComponent
  },
  {
  ...
  {
    path: "ListeDemandeProposition", component: ListeDemendePropositionComponent
  },
  {
