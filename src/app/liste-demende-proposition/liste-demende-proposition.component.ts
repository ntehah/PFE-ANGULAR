...
@Component({
  selector: 'app-liste-demende-proposition',
  templateUrl: './liste-demende-proposition.component.html',
  styleUrls: ['./liste-demende-proposition.component.scss']
})
export class ListeDemendePropositionComponent implements OnInit {
  mode;
  url2 = "/sujets";
  sujets;
  sujets1;
